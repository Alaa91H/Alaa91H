<!--
  ─────────────────────────────────────────────────────────────────────────────
  👋 Alaa — GitHub Profile README
  ─────────────────────────────────────────────────────────────────────────────
  HOW TO USE:
  1. On GitHub, create a NEW repository with the exact name:  Alaa91H
     (the repo must be named exactly like your username — it's a "special" repo)
  2. Make it Public, and paste this file as its README.md.
  3. (Optional) Add a personal line in the About Me section — e.g. "📍 Based in ___ · Open to collaborations".

  Everything else (stats, streak, top languages, badges, profile views)
  updates itself automatically from your GitHub account. Nothing to configure.

  NOTE: All images come from stable services (shields.io, komarev.com,
  demolab.com, vercel summary-cards). The older github-readme-stats and
  trophy services were intentionally NOT used — they suffer frequent
  outages and would show broken images on your profile.
  ─────────────────────────────────────────────────────────────────────────────
-->
...
I'm **Alaa**, an Android & systems developer who enjoys building things end-to-end — from native Kotlin apps and automation engines to custom kernels, ROMs, and the CI pipelines that ship them.

I'm currently focused on the **Nexa** family of Android projects (an automation engine, a companion SDK, and more), maintaining kernels for devices like the **POCO F5** and **Redmi Note 5 Pro**, and crafting practical tools such as the **NOVA Download Manager** and Islamic community services.

<!-- TODO: optional — add a personal line here, e.g. "📍 Based in ___ · Open to collaborations" -->

## 🚀 What I Do

| | |
|---|---|
| 📱 **Android Development** | Build native Android apps & automation engines in **Kotlin** — including the *NexaFlow* context-aware automation engine and the *Muslim* Islamic app. |
| ⚙️ **Custom ROMs & Kernels** | Maintain & build custom kernels (**Melt** for POCO F5 / Redmi Note 12 Turbo, **Phoenix** for Redmi Note 5 Pro), OneUI porting for Galaxy A53, and GitHub Actions CI that publishes kernel builds to recovery pipelines. |
| 🤖 **Automation & Tooling** | Write Python bots & tooling — Islamic unified bots, GCam tooling for POCO F5, and privacy-focused servers. |
| 🌐 **Web, Extensions & Desktop** | Build the **NOVA Download Manager** — a TypeScript Chrome extension with a Windows (NSIS) installer. |
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/NSIS%20Installers-1B1B1B?style=for-the-badge&logoColor=white" alt="NSIS" />
...
<p align="center">
  <a href="https://github.com/Alaa91H"><img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
  <a href="https://t.me/Alaa91h"><img src="https://img.shields.io/badge/Telegram-26A5E4?style=for-the-badge&logo=telegram&logoColor=white" alt="Telegram" /></a>
  <a href="mailto:alahus2591@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" /></a>
</p>

## ☕ Support Me

<p align="center">
  <i>Enjoying my work? A coffee would be nice! ☕</i>
</p>

<p align="center">
  <a href="https://ko-fi.com/alaa91h"><img src="https://ko-fi.com/img/githubbutton_sm.svg" alt="Support me on Ko-fi" /></a>
</p>
